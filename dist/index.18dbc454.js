...
var _gasp = require("gasp");
var _gaspDefault = parcelHelpers.interopDefault(_gasp);
var _gsap = require("gsap");
var _scrollTrigger = require("gsap/ScrollTrigger");
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger));
document.addEventListener("DOMContentLoaded", function() {
    (0, _gsap.gsap).to(".header-parallax", {
        scrollTrigger: {
...
},{"gasp":"hD2TV","gsap":"fPSuC","gsap/ScrollTrigger":"7wnFk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hD2TV":[function(require,module,exports) {
var Q = require("q");
module.exports = gasp;
function gasp(task, interval) {
    ...
    function gasped() {
        if (!inProgress) args = Array.prototype.slice.call(arguments, 0);
        else savedArgs = Array.prototype.slice.call(arguments, 0);
        if (!timeout) {
            ...
            timeout = setTimeout(function() {
                if (inProgress === true) {
                    ...
                    args = savedArgs;
                    if (gasped.delegate && typeof gasped.delegate.willCollideWithPreviousGasp === "function") gasped.delegate.willCollideWithPreviousGasp.call(null, gasped, args);
                ...
                // notify delegate
                if (gasped.delegate && typeof gasped.delegate.willGasp === "function") gasped.delegate.willGasp.call(null, gasped, args);
                clearTimeout(timeout);
                timeout = null;
                Q.fcall(function() {
...
},{"q":"6YRAJ"}],"6YRAJ":[function(require,module,exports) {
 ...
 */ (function(definition) {
    ...
    var nextTick = function() {
        ...
        if (typeof process === "object" && process.toString() === "[object process]" && process.nextTick) {
            ...
            if (typeof window !== "undefined") requestTick = setImmediate.bind(window, flush);
    ...
    var object_keys = Object.keys || function(object) {
        var keys = [];
        for(var key in object)if (object_hasOwnProperty(object, key)) keys.push(key);
        return keys;
    };
    ...
    else QReturnValue = function(value) {
        this.value = value;
    };
    // long stack traces
    ...
    function makeStackTraceLong(error, promise) {
        ...
        if (hasStacks && promise.stack && typeof error === "object" && error !== null && error.stack) {
            var stacks = [];
            for(var p = promise; !!p; p = p.source)if (p.stack && (!error.__minimumStackCounter__ || error.__minimumStackCounter__ > p.stackCounter)) {
    ...
    function deprecate(callback, name, alternative) {
        return function() {
            if (typeof console !== "undefined" && typeof console.warn === "function") console.warn(name + " is deprecated, use " + alternative + " instead.", new Error("").stack);
 ...
 */ function Q(value) {
        ...
        if (isPromiseAlike(value)) return coerce(value);
        else return fulfill(value);
    }
    Q.resolve = Q;
    /**
 ...
 */ var longStackCounter = 1;
    typeof process === "object" && process && process.env && undefined;
    /**
 ...
 */ Q.defer = defer;
    function defer() {
        ...
        promise.promiseDispatch = function(resolve, op, operands) {
            ...
            if (messages) {
                messages.push(args);
                if (op === "when" && operands[1]) progressListeners.push(operands[1]);
        ...
        promise.valueOf = function() {
            ...
            if (isPromise(nearerValue)) resolvedPromise = nearerValue; // shorten chain
            return nearerValue;
        };
 ...
 */ Q.Promise = promise1; // ES6
    ...
    promise1.race = race; // ES6
    promise1.all = all; // ES6
    promise1.reject = reject1; // ES6
    promise1.resolve = Q; // ES6
 ...
 */ Q.join = function(x, y) {
    ...
    Promise.prototype.join = function(that) {
        return Q([
            ...
            if (x === y) // TODO: "===" should be Object.is or equiv
            return x;
            else throw new Error("Q can't join: not the same: " + x + " " + y);
        });
    };
    /**
 ...
 */ Q.makePromise = Promise;
    function Promise(descriptor, fallback, inspect) {
        if (fallback === void 0) fallback = function(op) {
            return reject1(new Error("Promise does not support operation: " + op));
        };
        if (inspect === void 0) inspect = function() {
            return {
                state: "unknown"
            };
        };
        ...
        promise.promiseDispatch = function(resolve, op, args) {
            var result;
            try {
                if (descriptor[op]) result = descriptor[op].apply(promise, args);
                else result = fallback.call(promise, op, args);
            } catch (exception) {
                result = reject1(exception);
            }
        ...
        if (inspect) {
            var inspected1 = inspect();
            if (inspected1.state === "rejected") promise.exception = inspected1.reason;
            promise.valueOf = function() {
                var inspected = inspect();
                if (inspected.state === "pending" || inspected.state === "rejected") return promise;
 ...
 */ // XXX should we re-do this?
    ...
    function nearer(value) {
        if (isPromise(value)) {
            ...
            if (inspected.state === "fulfilled") return inspected.value;
        }
        return value;
    }
    /**
 ...
 */ Q.isRejected = isRejected;
    ...
    function trackRejection(promise, reason) {
        ...
        if (typeof process === "object" && typeof process.emit === "function") Q.nextTick.runAfter(function() {
        ...
        if (reason && typeof reason.stack !== "undefined") unhandledReasons.push(reason.stack);
        else unhandledReasons.push("(no stack) " + reason);
    }
    ...
    function fulfill(value) {
        return Promise({
            ...
            "post": function(name, args) {
                ...
                // promised function.
                if (name === null || name === void 0) return value.apply(void 0, args);
                else return value[name].apply(value, args);
            },
        ...
        return function() {
            ...
            function continuer(verb, arg) {
                ...
                if (typeof StopIteration === "undefined") {
                    ...
                    if (result.done) return Q(result.value);
                    else return when(result.value, callback, errback);
                } else {
                    ...
                    try {
                        ...
                        if (isStopIteration(exception)) return Q(exception.value);
                        else return reject1(exception);
                    }
 ...
 */ // By Mark Miller
    ...
    Q.all = all;
    function all(promises1) {
        return when(promises1, function(promises) {
            var pendingCount = 0;
            var deferred = defer();
            array_reduce(promises, function(undefined, promise, index) {
                var snapshot;
                if (isPromise(promise) && (snapshot = promise.inspect()).state === "fulfilled") promises[index] = snapshot.value;
                else {
                    ++pendingCount;
                    when(promise, function(value) {
                        promises[index] = value;
                        if (--pendingCount === 0) deferred.resolve(promises);
 ...
 */ Q.any = any;
    function any(promises) {
        if (promises.length === 0) return Q.resolve();
 ...
 */ Q.allResolved = deprecate(allResolved, "allResolved", "allSettled");
    function allResolved(promises2) {
        return when(promises2, function(promises) {
 ...
 */ Q.progress = progress1;
    function progress1(object, progressed) {
 ...
 */ Q.fin = Q["finally"] = function(object, callback) {
    ...
    Promise.prototype.fin = Promise.prototype["finally"] = function(callback) {
        if (!callback || typeof callback.apply !== "function") throw new Error("Q can't apply finally callback");
        callback = Q(callback);
        return this.then(function(value) {
 ...
 */ Q.nfbind = Q.denodeify = function(callback /*...args*/ ) {
        if (callback === undefined) throw new Error("Q can't wrap an undefined function");
 ...
 */ Q.nodeify = nodeify;
    ...
    Promise.prototype.nodeify = function(nodeback) {
        if (nodeback) this.then(function(value) {
            Q.nextTick(function() {
                nodeback(null, value);
            });
        }, function(error) {
...
var Context = /*#__PURE__*/ function() {
    ...
    var _proto5 = Context1.prototype;
    ...
    _proto5.getTweens = function getTweens() {
        ...
        this.data.forEach(function(e) {
            return e instanceof Context1 ? a.push.apply(a, e.getTweens()) : e instanceof Tween && !(e.parent && e.parent.data === "nested") && a.push(e);
        });
        return a;
    };
...
var MatchMedia = /*#__PURE__*/ function() {
    function MatchMedia1(scope) {
        this.contexts = [];
        this.scope = scope;
    }
    var _proto6 = MatchMedia1.prototype;
...
var ScrollTrigger = /*#__PURE__*/ function() {
    ...
    _proto.init = function init(vars, animation) {
        ...
        var _vars = vars, onUpdate = _vars.onUpdate, toggleClass = _vars.toggleClass, id = _vars.id, onToggle = _vars.onToggle, onRefresh = _vars.onRefresh, scrub = _vars.scrub, trigger = _vars.trigger, pin = _vars.pin, pinSpacing = _vars.pinSpacing, invalidateOnRefresh = _vars.invalidateOnRefresh, anticipatePin = _vars.anticipatePin, onScrubComplete = _vars.onScrubComplete, onSnapComplete = _vars.onSnapComplete, once = _vars.once, snap3 = _vars.snap, pinReparent = _vars.pinReparent, pinSpacer = _vars.pinSpacer, containerAnimation = _vars.containerAnimation, fastScrollEnd = _vars.fastScrollEnd, preventOverlaps = _vars.preventOverlaps, direction = vars.horizontal || vars.containerAnimation && vars.horizontal !== false ? (0, _observerJs._horizontal) : (0, _observerJs._vertical), isToggle = !scrub && scrub !== 0, scroller = (0, _observerJs._getTarget)(vars.scroller || _win), scrollerCache = gsap.core.getCache(scroller), isViewport = _isViewport(scroller), useFixedPosition = ("pinType" in vars ? vars.pinType : (0, _observerJs._getProxyProp)(scroller, "pinType") || isViewport && "fixed") === "fixed", callbacks = [
            vars.onEnter,
            vars.onLeave,
            vars.onEnterBack,
            vars.onLeaveBack
    ...
    ScrollTrigger1.enable = function enable() {
        ...
        if (gsap) {
            ...
            if (_body) {
                ...
                ScrollTrigger1.isTouch = (0, _observerJs.Observer).isTouch;
...
_inputObserver = function _inputObserver(target, type, inputs, nested) {
    ...
    self1 = new (0, _observerJs.Observer)(vars);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jQVXF","1SICI"], "1SICI", "parcelRequire0300")
